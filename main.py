    ...
    for r in range(len(board)):
        for c in range(len(board) - 3):
            while abs(board[r][c]) == abs(board[r][c+1]) == abs(board[r][c+2]) == abs(board[r][c+3]) != 0:
                ...
                inlocuire()
                print(board, "\n")
                print("linie de 4 cu mutare de la stanga la dreapta")
                print("scor = ", scor)
                print("mutari = ", mutari)
                print("\n")
                zdrobire = False
...
def linie_de_4_cu_mutare():
    ...
    for r in range(len(board)):
        for c in range(len(board) - 4):
            while abs(board[r][c]) == abs(board[r][c+1]) == abs(board[r][c+2]) == abs(board[r][c-2]) != 0:
                board[r][c-2], board[r][c-1] = board[r][c-1], board[r][c-2]
                board[r][c - 1] = board[r][c] = board[r][c+1] = board[r][c+2] = 0
                scor += 10
                mutari += 1
                print(board, "\n")
                drop()
                ...
                inlocuire()
                print(board, "\n")
                print("linie de 4 de la stanga la dreapta")
                print("scor = ", scor)
                print("mutari = ", mutari)
                print("\n")
                zdrobire = False
    ...
    for r in range(len(board)):
        for c in range(len(board)-4):
            while abs(board[r][c-2]) == abs(board[r][c-1]) == abs(board[r][c]) == abs(board[r][c+2]) != 0:
                board[r][c+1], board[r][c+2] = board[r][c+2], board[r][c+1]
                board[r][c-2] = board[r][c-1] = board[r][c] = board[r][c+1] = 0
                scor += 10
                mutari += 1
                print(board, "\n")
                drop()
                ...
                inlocuire()
                print(board, "\n")
                print("linie de 4 de la dreapta la stanga")
                print("\n")
                print("scor = ", scor)
                print("mutari = ", mutari)
                zdrobire = False
    ...
    for r in range(len(board)-4):
        for c in range(len(board)):
            while abs(board[r-2][c]) == abs(board[r-1][c]) == abs(board[r][c]) == abs(board[r+2][c]) != 0:
                board[r+2][c], board[r+1][c] = board[r+1][c], board[r+2][c]
                board[r-2][c] = board[r-1][c] = board[r][c] = board[r+1][c] = 0
                scor += 10
                mutari += 1
                print(board, "\n")
                drop()
                ...
                inlocuire()
                print(board, "\n")
                print("coloana de 4 de jos in sus")
                print("scor = ", scor)
                print("mutari = ", mutari)
                print("\n")
                zdrobire = False
    ...
    for r in range(len(board)-4):
        for c in range(len(board)):
            while abs(board[r+2][c]) == abs(board[r+1][c]) == abs(board[r][c]) == abs(board[r-2][c]) != 0:
                ...
                board[r-1][c] = board[r][c] = board[r+1][c] = board[r+2][c] = 0
                scor += 10
                mutari += 1
                print(board, "\n")
                drop()
                ...
                inlocuire()
                print(board, "\n")
                print("coloana de 4 de sus in jos")
                print("\n")
                print("scor = ", scor)
                print("mutari = ", mutari)
                zdrobire = False
...
def linie_de_3_cu_mutare():
    ...
    for r in range(len(board)):
        for c in range(len(board) - 2):
            while abs(board[r][c-2]) == abs(board[r][c]) == abs(board[r][c+1])  != 0:
                board[r][c-1], board[r][c-2] = board[r][c-2], board[r][c-1]
                print(board)
                board[r][c] = board[r][c+1] = board[r][c-1] = 0
                scor += 5
                mutari += 1
                print(board, "\n")
                drop()
                ...
                inlocuire()
                print(board, "\n")
                print("linie de 3 cu mutare de la stanga la dreapta")
                print("scor = ", scor)
                print("mutari = ", mutari)
                print("\n")
                zdrobire = False
    ...
    for r in range(len(board)):
        for c in range(len(board) - 2):
            while abs(board[r][c-1]) == abs(board[r][c]) == abs(board[r][c+2])  != 0:
                board[r][c+1], board[r][c+2] = board[r][c+2], board[r][c+1]
                print(board)
                board[r][c] = board[r][c+1] = board[r][c-1] = 0
                scor += 5
                ...
                inlocuire()
                print(board, "\n")
                print("linie de 3 cu mutare de la dreapta la stanga")
                print("scor = ", scor)
                print("mutari = ", mutari)
                print("\n")
                zdrobire = False
    ...
    for r in range(len(board) - 2):
        for c in range(len(board)):
            while abs(board[r-2][c]) == abs(board[r][c]) == abs(board[r+1][c]) != 0:
                board[r - 2][c], board[r - 1][c] = board[r-1][c], board[r - 2][c]
                ...
                inlocuire()
                print(board, "\n")
                print("coloana de 3 cu mutare de sus in jos")
                print("\n")
                print("scor = ", scor)
                print("mutari = ", mutari)
                zdrobire = False
    ...
    for r in range(len(board) - 2):
        for c in range(len(board)):
            while abs(board[r-1][c]) == abs(board[r][c]) == abs(board[r+2][c]) != 0:
                board[r + 2][c], board[r + 1][c] = board[r+1][c], board[r + 2][c]
                board[r-1][c] = board[r][c] = board[r+1][c] = 0
                scor += 5
                mutari += 1
